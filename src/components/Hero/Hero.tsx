...
export const Hero = ({ games }: {games: any[] }) => {
    ...
    return (
    <div className="pr-9 pl-9 my-6 h-[42vh] flex-center">
        <div className="flex-center">
            <div className="flex-center flex-col">
                ...
                height={150}
                />
                <h1 className="text-3xl">The Best Nintendo 64 fan website</h1>
            </div>
        </div>
    
    <div className="ml-auto w-[490px] h-full border border-slate-700 p-2 rounded-lg" style={style}>
